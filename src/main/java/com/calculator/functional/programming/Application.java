...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        IDivision calculateDivision = (x, y) -> IntStream.rangeClosed(0, x).reduce((acum, num) -> calculateMultiplication.mult(acum, y) <= x ? acum+1 : acum).getAsInt()-1;
        ...
        System.out.println("The division is: " + calculateDivision.division(176, 16));
    }
}
